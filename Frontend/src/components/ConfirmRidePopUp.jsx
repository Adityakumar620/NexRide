...
function ConfirmRidePopUp(props) {
  return (
    <div>
      <h5 className="text-2xl font-semibold p-2">Confirm this ride to start</h5>
      <h5
        onClick={() => {
      ...
      <div className="flex gap-2 justify-between items-center flex-col ">
        ...
        <div className=" w-full">
          <Link to="/caption-riding" className="flex items-center justify-center mt-3 w-full bg-green-600 text-white font-semibold p-3 rounded-lg ">
            Confirm
          </Link>
          <button
            onClick={() => {
            ...
            className=" mt-3 w-full bg-red-500 text-white font-semibold p-3 rounded-lg "
          >
            Cancel
          </button>
        </div>
